...
public class MyUserDetailService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String memberName) throws UsernameNotFoundException {
        CoreUser coreUser = coreUserDao.findUserByLoginName(memberName);
        if (coreUser == null) {
        ...
        // }
        // }
        User user = new User(coreUser.getCode(), coreUser.getPw(), enabled, accountNonExpired, credentialsNonExpired,
